<nav x-data="{ open: false, submenuOpen: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Visi Misi with Submenu -->
                    <div class="relative flex justify-center items-center" @mouseenter="submenuOpen = true"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Visi Misi with Submenu for Mobile -->
            <div>
                <x-responsive-nav-link>
                    {{ __('Visi Misi') }}
                </x-responsive-nav-link>
