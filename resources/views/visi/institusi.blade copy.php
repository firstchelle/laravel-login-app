<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="w-full h-auto p-4 sm:p-8 rounded-md space-y-4">
                    <div class="flex flex-col gap-4">
                        <p class="text-2xl sm:text-4xl font-bold">VISI & MISI</p>
                                    ...
                                    <tr class="bg-white">
                                        ...
                                        <td class="p-2 border border-gray-300 text-left">
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="{{ route('visiinstitusi.edit', $dt->id) }}"
                                                    class=" 
    ...
    ">
                                                ...
                                                {{-- Delete Button --}}
                                                <form action="{{ route('visiinstitusi.destroy', $dt->id) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
