        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="w-full h-auto flex flex-col p-4">
                    ...
                    {{-- Form --}}
                    {{-- @dd($item->id) --}}
                    <form action="{{ route('visiinstitusi.update', $item->id) }}" method="POST"
                        ...
                        <div>
                            ...
                            <select name="jenis" id="jenis" class="border border-gray-300 rounded-md p-2 w-full">
                                <option value="visi" {{ old('jenis', $item->jenis) == 'visi' ? 'selected' : '' }}>Visi
                                </option>
                                <option value="misi" {{ old('jenis', $item->jenis) == 'misi' ? 'selected' : '' }}>Misi
                                </option>
                            </select>
                        </div>
