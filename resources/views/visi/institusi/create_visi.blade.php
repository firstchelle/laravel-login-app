        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    {{-- Header --}}
                    <div class="mb-6">
                        <h2 class="text-2xl font-bold text-gray-800">Tambah Visi Institusi</h2>
                        <p class="text-gray-600 mt-1">Isi formulir di bawah untuk menambahkan visi institusi</p>
                    </div>

                    {{-- Form --}}
                    <form action="{{ route('visiinstitusi.store_visi') }}" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <textarea name="visi" id="visi" rows="6"
                                ...
                                placeholder="Masukkan visi institusi...">{{ old('visi') }}</textarea>
                            @error('visi')
