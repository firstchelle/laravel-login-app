    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Daftar Visi Fakultas</h3>
                                            ...
                                            @if (auth()->user()->role === 'dekan')
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                                    <div class="flex justify-center gap-3">
                                                        {{-- Edit --}}
                                                        <a href="{{ route('visifakultas.edit_visi', $item->id) }}"
                                                        ...
                                                        {{-- Delete --}}
                                                        <form action="{{ route('visifakultas.hapus_visi', $item->id) }}"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Daftar Misi Fakultas</h3>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($misi as $item)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-900">
                                                @if ($item->visiFakultas)
                                                    <p class="line-clamp-2 text-xs text-gray-600">
                                                        {{ Str::limit($item->visiFakultas->visi, 50) }}</p>
                                                @else
                                            ...
                                            @if (auth()->user()->role === 'dekan')
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                                    <div class="flex justify-center gap-3">
                                                        {{-- Edit --}}
                                                        <a href="{{ route('visifakultas.edit_misi', $item->id) }}"
                                                            class="text-blue-600 hover:text-blue-900 transition duration-200"
                                                            title="Edit">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                                fill="none" viewBox="0 0 24 24"
                                                        ...
                                                        {{-- Delete --}}
                                                        <form
                                                            action="{{ route('visifakultas.hapus_misi', $item->id) }}"
                                                            method="POST" class="inline">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button type="button"
